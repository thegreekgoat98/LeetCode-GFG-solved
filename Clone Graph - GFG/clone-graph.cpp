...
public:
    ...
    //It has become one of my favoutite question, it has a very nice concept of using map.
    //Solved it last night for the first time on Leetcode(Daily challange), now solved here
};
