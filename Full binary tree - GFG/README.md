# Full binary tree
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree. Check whether the Binary tree is a full binary tree or not.</span></p>
